...
yy = [0.93,0.69,0.13];
p = [0.49,0.18,0.56];
g = [0.47,0.67,0.19];% %legendText = legend([l1,l2],'总延迟（s）','总能量消耗（mJ）','FontSize',sizech);
z = [0.30,0.75,0.93];%'\fontname{宋体}{加速度{\fontname{Times new roman}{(g)'

dpi = 1000; % DPI
output_folder = 'D:\hexiaom\第三章0710'; % 输出目录
position = [3 5 9 6.5];
A = 25;
B = -5*sqrt(3);
C = 5*0.42435;
...
%%
rx = [print_prx(2),print_prx(3),print_prx(4),print_prx(5),print_prx(6),print_prx(8),print_prx(9)];
ry = [print_pry(2),print_pry(3),print_pry(4),print_pry(5),print_pry(6),print_pry(8),print_pry(9)];
rz = [print_prz(2),print_prz(3),print_prz(4),print_prz(5),print_prz(6),print_prz(8),print_prz(9)];
C1x = [print_C1x(2),print_C1x(3),print_C1x(4),print_C1x(5),print_C1x(6),print_C1x(8),print_C1x(9)];
C1y = [print_C1y(2),print_C1y(3),print_C1y(4),print_C1y(5),print_C1y(6),print_C1y(8),print_C1y(9)];
C1z = [print_C1z(2),print_C1z(3),print_C1z(4),print_C1z(5),print_C1z(6),print_C1z(8),print_C1z(9)];
...
% 
% m1 = [print_C11x(2),print_C11x(3),print_C11x(4),print_C11x(5),print_C11x(6),print_C11x(8),print_C11x(9)];
% n1 = [print_C11y(2),print_C11y(3),print_C11y(4),print_C11y(5),print_C11y(6),print_C11y(8),print_C11y(9)];
% o1 = [print_C11z(2),print_C11z(3),print_C11z(4),print_C11z(5),print_C11z(6),print_C11z(8),print_C11z(9)];
% scatter3(C1x,C1y,C1z,1600,'r','DisplayName','position before iteration');
% hold on 
% scatter3(rx,ry,rz,1600,'k','+','DisplayName','correct position');
% hold on
% scatter3(m1,n1,o1,800,'b','filled','DisplayName','position after iteration');
...
% m2 = [print_C12x(2),print_C12x(3),print_C12x(4),print_C12x(5),print_C12x(6),print_C12x(8),print_C12x(9)];
% n2 = [print_C12y(2),print_C12y(3),print_C12y(4),print_C12y(5),print_C12y(6),print_C12y(8),print_C12y(9)];
% o2 = [print_C12z(2),print_C12z(3),print_C12z(4),print_C12z(5),print_C12z(6),print_C12z(8),print_C12z(9)];
% scatter3(m1,n1,o1,1600,'r','DisplayName','position before iteration');
% hold on 
% scatter3(rx,ry,rz,1600,'k','+','DisplayName','correct position');
% hold on
% scatter3(m2,n2,o2,800,'b','filled','DisplayName','position after iteration');
...
m3 = [print_C13x(2),print_C13x(3),print_C13x(4),print_C13x(5),print_C13x(6),print_C13x(8),print_C13x(9)];
n3 = [print_C13y(2),print_C13y(3),print_C13y(4),print_C13y(5),print_C13y(6),print_C13y(8),print_C13y(9)];
o3 = [print_C13z(2),print_C13z(3),print_C13z(4),print_C13z(5),print_C13z(6),print_C13z(8),print_C13z(9)];
scatter3(m2,n2,o2,1600,'r','DisplayName','position before iteration');
hold on 
scatter3(rx,ry,rz,1600,'k','+','DisplayName','correct position');
hold on
scatter3(m3,n3,o3,800,'b','filled','DisplayName','position after iteration');
...
% m4 = [print_C14x(2),print_C14x(3),print_C14x(4),print_C14x(5),print_C14x(6),print_C14x(8),print_C14x(9)];
% n4 = [print_C14y(2),print_C14y(3),print_C14y(4),print_C14y(5),print_C14y(6),print_C14y(8),print_C14y(9)];
% o4 = [print_C14z(2),print_C14z(3),print_C14z(4),print_C14z(5),print_C14z(6),print_C14z(8),print_C14z(9)];
% scatter3(m3,n3,o3,1600,'r','DisplayName','position before iteration');
% hold on 
% scatter3(rx,ry,rz,1600,'k','+','DisplayName','correct position');
% hold on
% scatter3(m4,n4,o4,800,'b','filled','DisplayName','position after iteration');
% 
